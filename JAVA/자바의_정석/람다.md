...
![TVafter](../../IMG/TVafter.PNG)

* default <V> Function<V,R> compose(Function<? super V, ? extends T> before)

![VRbefore](../../IMG/VRbefore.PNG)
...
참조변수 f의 타입만 봐도 String타입이 2개 오는 것을 알 수 있기 때문에 `s1`, `s2`는 제거해도 된다. 그럼 두 개의 String을 equals()로 Boolean값을 바로 반환하면 좋겠지만 같은 메서드가 다른 클래스에 존재할 수 있기 때문에 equals() 앞에 클래스 이름이 필요하다.
