...
* 다중 클라이언트와 병렬적으로 통신하는 모습![KakaoTalk_Image_2022-03-14-23-40-25]![1](https://user-images.githubusercontent.com/84169773/160957585-86c4d1e0-698d-4529-a7b4-3003b297b843.jpg)


  : 스레드로 병렬처리를 할 경우, 수천 개의 클라이언트가 동시에 연결되면 서버에서 수천 개의 스레드가 생성되기 때문에 서버 성능이 급격하게 저하된다. 클라이언트 폭증의 이슈를 방지하려면 스레드풀을 사용하는 것이 바람직하다.

* 스레드풀을 이용한 서버 구현 방식![KakaoTalk_Image_2022-03-14-23-40-31]![2](https://user-images.githubusercontent.com/84169773/160957569-85b30e8e-3514-439d-8620-4c3bc48ef06a.jpg)
